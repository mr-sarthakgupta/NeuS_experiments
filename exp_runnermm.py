...
class Runner:
    def __init__(self, conf_path, mode='train', case='CASE_NAME', is_continue=False):
        ...
        self.pose_optimizer = torch.optim.Adam(self.pose_net.parameters(), lr=self.learning_rate)
        self.scheduler_pose = torch.optim.lr_scheduler.MultiStepLR(self.pose_optimizer, milestones=list(range(0, 10_000, 1_00_000)), gamma=0.1)
